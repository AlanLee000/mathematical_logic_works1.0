...
2.  **后继步 ($U_{\alpha} \to U_{\alpha+1}$)**：
    ...
    *   **扩展项集 ($\text{Term}_{\alpha+1}$)**：
        $$ \begin{aligned} \text{Term}_{\alpha+1} = \text{Term}_\alpha &\cup \{ f(\vec{t}) \mid f \in \text{Func}, \vec{t} \in \text{Term}_{\alpha} \} \\ &\cup \{ F_\varphi(t) \mid \varphi \in \text{Form}_{\alpha}, t \in \text{Term}_{\alpha} \} \end{aligned} $$
    
    *   **扩展语句集 ($\text{Stat}_{\alpha+1}$)**：
        $$ \begin{aligned} \text{Stat}_{\alpha+1} = \text{Stat}_\alpha &\cup \{ P(\vec{t}) \mid P \in \text{Pred}, \vec{t} \in \text{Term}_{\alpha+1} \} \\ &\cup \{ \mathfrak{D}(t, \Gamma) \mid t \in \text{Term}_{\alpha+1}, \Gamma \in \text{Fin}(\text{Stat}_{\alpha}) \} \end{aligned} $$
